...
!function($) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.applyClass = 'btn-success btn-sm';
            ...
            switch (language) {
                case "fr":
                    this.locale = {
                        ...
                        daysOfWeek: "Di_Lu_Ma_Me_Je_Ve_Sa".split("_"),
                        monthNames: "janv._févr._mars_avr._mai_juin_juil._août_sept._oct._nov._déc.".split("_"),
                        firstDay: 0
                    };
                    break;
                case "jp":
                    this.locale = {
                        ...
                        toLabel: 'To',
                        weekLabel: 'W',
                        customRangeLabel: 'パーソナライズビーチ',
                        daysOfWeek: "日_一_二_三_四_五_六".split("_"),
                        monthNames: "一月._二月._三月_四月._五月_六月_七月._八月_九月._十月._十一月._十二月.".split("_"),
                        firstDay: 0
                    };
                    break;
                case "en":
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu small">' +
                '<div class="calendar left small"></div>' +
                '<div class="calendar right small"></div>' +
                '<div class="ranges">' +
