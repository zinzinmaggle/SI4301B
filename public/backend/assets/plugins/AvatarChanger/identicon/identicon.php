...
abstract class Identicon
{
	...
	private static function getsprite($shape,$R,$G,$B,$rotation) {
		global $spriteZ;
	...
	private static function getcenter($shape,$fR,$fG,$fB,$bR,$bG,$bB,$usebg) {
		global $spriteZ;
		$sprite=imagecreatetruecolor($spriteZ,$spriteZ);
		imageantialias($sprite,TRUE);
	...
	public static function create($hash, $width, $height)
	{
		global $spriteZ;
