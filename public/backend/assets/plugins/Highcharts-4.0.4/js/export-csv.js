...
(function(Highcharts) {
    ...
    Highcharts.Chart.prototype.getCSV = function() {
        var columns = [],
                ...
                // Options
                dateFormat = options.dateFormat || '%Y-%m-%d %H:%M',
        ...
        maxRows = Math.max.apply(this, Highcharts.map(columns, function(col) {
            return col.length;
        }));
...
//                } else {
                    Highcharts.post('/backend/assets/plugins/Highcharts-4.0.4/export-csv.php', {
                        csv: this.getCSV()
                    });
//                }
