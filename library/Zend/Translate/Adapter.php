 ...
 * @see Zend_Locale
 */
require_once ZEND_LIBRARY.'Zend/Locale.php';

/**
 * @see Zend_Translate_Plural
 */
require_once ZEND_LIBRARY.'Zend/Translate/Plural.php';
...
abstract class Zend_Translate_Adapter {
    ...
    public function addTranslation($options = array())
    {
        ...
        if (!isset($options['content']) || empty($options['content'])) {
            require_once ZEND_LIBRARY.'Zend/Translate/Exception.php';
    ...
    {
        require_once ZEND_LIBRARY.'Zend/Cache.php';
        if (self::$_cacheTags) {
            if ($tag == null) {
                $tag = 'Zend_Translate';
            }
