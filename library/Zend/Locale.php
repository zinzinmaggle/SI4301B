...
class Zend_Locale
{
    ...
    public static function setDefault($locale, $quality = 1)
    {
        if (($locale === 'auto') or ($locale === 'root') or ($locale === 'default') or
            ...
            require_once ZEND_LIBRARY.'Zend/Locale/Exception.php';
    ...
    public static function getEnvironment()
    {
        ...
        require_once ZEND_LIBRARY.'Zend/Locale/Data/Translation.php';
    ...
    {
        require_once ZEND_LIBRARY.'Zend/Locale/Data.php';
    ...
    {
        if ($locale === null) {
            require_once ZEND_LIBRARY.'Zend/Registry.php';
