...
class Mandrill {
    ...
    public $debug = false;
    /* @var $templates Mandrill_Templates */
    public $templates;
    /* @var $exports Mandrill_Exports */
    public $exports;
    /* @var $users Mandrill_Users */
    public $users;
    /* @var $rejects Mandrill_Rejects */
    public $rejects;
    /* @var $inbound Mandrill_Inbound */
    public $inbound;
    /* @var $tags Mandrill_Tags */
    public $tags;
    /* @var Mandrill_Messages $messages  */
    public $messages;
    /* @var $whitelists Mandrill_Whitelists */
    public $whitelists;
    /* @var $ips Mandrill_Ips */
    public $ips;
    /* @var $internal Mandrill_Internal */
    public $internal;
    /* @var $subaccounts Mandrill_Subaccounts */
    public $subaccounts;
    /* @var $urls Mandrill_Urls */
    public $urls;
    /* @var $webhooks Mandrill_Webhooks */
    public $webhooks;
    /* @var $senders Mandrill_Senders */
    public $senders;
    /* @var $metadata Mandrill_Metadata */
    public $metadata;
